            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-left pt-2"> Country Office  list</h3>

                        <div class="card-tools float-right">
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                  <button id="addNew" name="addNew" class="btn btn-primary  text-white"><i class="fa fa-plus-circle"></i> Add CountryOffice</button>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <button onclick="myFormReset()" type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                        </div>
                                        <div class="modal-body">
                                          <!--  <h4 align="center" style="margin:0;color: indianred;">Are you sure you want to remove this data?</h4> -->
                                          <h5 align="center" style="margin:0;color: indianred;">Are you sure you want to remove <span id="deleteValueName" class="text-secondary"></span> Country Office ?</h5>
                                        ...
                                        <div class="modal-footer">
                                            <form class="deleteById" id="deleteById">
                                                @csrf
                                                @method('DELETE')
                                                <input type="hidden" name="officeId" value="" id="officeId"/>
                                                <button id="okBtn" type="submit" name="edit" class="delete btn btn-danger">OK</button>
                                            </form>
                                            <!-- <button type="button" name="ok_button" id="ok_button" class="btn btn-danger">OK</button> -->
                                            <button onclick="myFormReset()" type="button" class="btn btn-secondary waves-effect" aria-label="Close" data-dismiss="modal">Cancel</button>
...
@section('script')
  ...
  @include('rapidPro.countryOffice.office_script');
