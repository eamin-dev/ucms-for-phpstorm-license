...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(RolePermissionController::class)->group(
        function () {
    ...
    Route::controller(IogtController::class)->group(
        function () {
    ...
    Route::controller(CountryOfficeController::class)->prefix('country-offices')->group(
        function () {
    ...
    Route::controller(ThemeficAreaController::class)->group(
        function () {
    ...
    Route::controller(NewRapidFlowController::class)->group(
        function () {
    ...
    Route::controller(QuestionManageController::class)->group(
        function () {
    ...
    Route::controller(ProfileManageController::class)->group(
        function () {
    ...
    Route::controller(RegionController::class)->prefix('regions')->group(
        function () {
    ...
    Route::controller(AdminController::class)->prefix('admins')->group(
        function () {
